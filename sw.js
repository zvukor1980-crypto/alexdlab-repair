const CACHE='repairlab-v7-trust-scan';
const ASSETS=['./','index.html','iphone.html?v=7','styles.css?v=7','app.js?v=7','jailbreak.js?v=7','data/devices.json','manifest.webmanifest'];
